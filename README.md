...
3. Run an HTTP server of your choice (`python -m http.server`) inside the root folder of this project and access generated data at `http://localhost:8000/index.html`
...
4. Run an HTTP server of your choice (`python -m http.server`) inside the root folder of this project and access generated data at `http://localhost:8000/index.html`, which will also include your SET
...
### `/index.html`
- The main page that is used to show processed data.

### `/run_analysis.py`
- Python script that is used to run full analysis by using scripts from the `/src` folder.
